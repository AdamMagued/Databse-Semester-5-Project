...
-- RESET IDENTITIES (So Jack is ID 1, not 17)
DBCC CHECKIDENT ('Employee', RESEED, 0);
DBCC CHECKIDENT ('Leave', RESEED, 0);
DBCC CHECKIDENT ('Attendance', RESEED, 0);
DBCC CHECKIDENT ('Document', RESEED, 0);
-- OR if you haven't created that proc, run your 'dropAllTables' and then 'createAllTables'
USE University_HR_ManagementSystem;
go
------
...
values (5,20,'pending')
------------------------------------------------------
-- 1. CLEANUP (Only deleting our test IDs to avoid duplicates)
DELETE FROM Employee_Approve_Leave WHERE Emp1_ID IN (100, 103);
DELETE FROM Employee_Replace_Employee WHERE Emp1_ID IN (100, 101, 102);
DELETE FROM Annual_Leave WHERE emp_ID IN (100, 101, 102);
DELETE FROM Unpaid_Leave WHERE Emp_ID IN (100, 101, 102);
DELETE FROM Document WHERE emp_ID IN (100, 101, 102);
DELETE FROM Attendance WHERE emp_ID IN (100, 101, 102);
DELETE FROM Employee_Role WHERE emp_ID IN (100, 101, 102, 103);
DELETE FROM Leave WHERE request_ID IN (200, 201);
DELETE FROM Employee WHERE employee_id IN (100, 101, 102, 103);

-- 2. ENSURE DEPARTMENTS EXIST
IF NOT EXISTS (SELECT * FROM Department WHERE name='MET') INSERT INTO Department VALUES ('MET','C');
IF NOT EXISTS (SELECT * FROM Department WHERE name='HR') INSERT INTO Department VALUES ('HR','B');

-- 3. ENSURE ROLES EXIST (FIXED: Added Title and Description columns)
IF NOT EXISTS (SELECT * FROM Role WHERE role_name='Dean') 
   INSERT INTO Role VALUES ('Dean', 'Academic Dean', 'Manage Dept', 3, 60000, 18, 18, 40, 12);

IF NOT EXISTS (SELECT * FROM Role WHERE role_name='Lecturer') 
   INSERT INTO Role VALUES ('Lecturer', 'Academic Lecturer', 'Teach Courses', 5, 45000, 12, 12, 30, 12);

IF NOT EXISTS (SELECT * FROM Role WHERE role_name='HR Manager') 
   INSERT INTO Role VALUES ('HR Manager', 'Manager', 'Manage HR', 3, 60000, 18, 18, 40, 12);

-- 4. LINK ROLES TO DEPARTMENTS
IF NOT EXISTS (SELECT * FROM Role_existsIn_Department WHERE Role_name='Dean' AND department_name='MET')
   INSERT INTO Role_existsIn_Department VALUES ('MET','Dean');

IF NOT EXISTS (SELECT * FROM Role_existsIn_Department WHERE Role_name='Lecturer' AND department_name='MET')
   INSERT INTO Role_existsIn_Department VALUES ('MET','Lecturer');

IF NOT EXISTS (SELECT * FROM Role_existsIn_Department WHERE Role_name='HR Manager' AND department_name='HR')
   INSERT INTO Role_existsIn_Department VALUES ('HR','HR Manager');

-- 5. INSERT EMPLOYEES (Forcing IDs 100-103)
SET IDENTITY_INSERT Employee ON;

INSERT INTO Employee (employee_id, first_name, last_name, password, email, dept_name, type_of_contract, annual_balance, employment_status, gender, official_day_off)
VALUES 
(100, 'Hazem', 'Ali', '123', 'hazem@guc.edu.eg', 'MET', 'full_time', 30, 'active', 'M', 'Friday'), 
(101, 'Hadeel', 'Adel', '123', 'hadeel@guc.edu.eg', 'MET', 'full_time', 30, 'active', 'F', 'Friday'), 
(102, 'Sarah', 'Sabry', '123', 'sarah@guc.edu.eg', 'MET', 'full_time', 0, 'active', 'F', 'Friday'), 
(103, 'Ahmed', 'Helmy', '123', 'ahmed@guc.edu.eg', 'HR', 'full_time', 30, 'active', 'M', 'Saturday');

SET IDENTITY_INSERT Employee OFF;

-- 6. ASSIGN ROLES
INSERT INTO Employee_Role VALUES (100, 'Dean'), (101, 'Lecturer'), (102, 'Lecturer'), (103, 'HR Manager');

-- 7. INSERT LEAVES (Forcing IDs 200, 201)
SET IDENTITY_INSERT Leave ON;

-- Request #200: Annual Leave for Hadeel (101)
INSERT INTO Leave (request_ID, date_of_request, start_date, end_date, final_approval_status) 
VALUES (200, GETDATE(), '2025-12-20', '2025-12-25', 'Pending');

-- Request #201: Unpaid Leave for Sarah (102)
INSERT INTO Leave (request_ID, date_of_request, start_date, end_date, final_approval_status) 
VALUES (201, GETDATE(), '2025-12-10', '2025-12-12', 'Pending');
...
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 200, 'Pending'); -- Assign to Dean
...
VALUES ('Memo', 'Need cash', 'doc.pdf', GETDATE(), 'valid', 102, 201);
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 201, 'Pending'); -- Assign to Dean

-- 9. ATTENDANCE (For Compensation Test)
INSERT INTO Attendance (date, check_in_time, check_out_time, status, emp_ID)
...
-- 1. CLEANUP (Only deleting our specific test IDs)
DELETE FROM Employee_Approve_Leave WHERE Emp1_ID IN (100, 103);
DELETE FROM Employee_Replace_Employee WHERE Emp1_ID IN (100, 101, 102);
DELETE FROM Annual_Leave WHERE emp_ID IN (100, 101, 102);
DELETE FROM Unpaid_Leave WHERE Emp_ID IN (100, 101, 102);
...
-- 2. FORCE BIG IDs (Ensures clean test environment)
DBCC CHECKIDENT ('Employee', RESEED, 99);
DBCC CHECKIDENT ('Leave', RESEED, 199);
DBCC CHECKIDENT ('Attendance', RESEED, 0);
DBCC CHECKIDENT ('Document', RESEED, 0);

-- 3. SETUP DEPARTMENTS & ROLES (FIXED: Includes HR Representative MET definition)
INSERT INTO Department VALUES ('MET','C'), ('HR','B');
...
('HR_Representative_MET', 'HR Rep', 'Assigns Approvals', 4, 50000, 15.00, 15.00, 35, 12); -- ADDED MISSING ROLE

INSERT INTO Role_existsIn_Department VALUES ('MET','Dean'), ('MET','Lecturer'), ('HR','HR Manager'), ('HR','HR_Representative_MET');
...
INSERT INTO Employee (employee_id, first_name, last_name, password, email, dept_name, type_of_contract, annual_balance, employment_status, gender, official_day_off)
VALUES 
(100, 'Hazem', 'Ali', '123', 'hazem@guc.edu.eg', 'MET', 'full_time', 30, 'active', 'M', 'Friday'), -- Dean
(101, 'Hadeel', 'Adel', '123', 'hadeel@guc.edu.eg', 'MET', 'full_time', 30, 'active', 'F', 'Friday'), -- Employee w/ Balance
(102, 'Sarah', 'Sabry', '123', 'sarah@guc.edu.eg', 'MET', 'full_time', 0, 'active', 'F', 'Friday'), -- Employee w/ 0 Balance
(103, 'Ahmed', 'Helmy', '123', 'ahmed@guc.edu.eg', 'HR', 'full_time', 30, 'active', 'M', 'Saturday'); -- HR Manager

SET IDENTITY_INSERT Employee OFF;

-- 5. ASSIGN ROLES (FIXED: Assigned HR Rep role to Ahmed)
INSERT INTO Employee_Role VALUES 
(100, 'Dean'), 
(101, 'Lecturer'), 
(102, 'Lecturer'), 
(103, 'HR Manager'),
(103, 'HR_Representative_MET'); -- ASSIGNED THE MISSING ROLE

-- 6. INSERT LEAVES (High IDs 200, 201)
SET IDENTITY_INSERT Leave ON;

INSERT INTO Leave (request_ID, date_of_request, start_date, end_date, final_approval_status) 
VALUES (200, GETDATE(), '2025-12-20', '2025-12-25', 'Pending'); -- Annual
INSERT INTO Leave (request_ID, date_of_request, start_date, end_date, final_approval_status) 
VALUES (201, GETDATE(), '2025-12-10', '2025-12-12', 'Pending'); -- Unpaid

SET IDENTITY_INSERT Leave OFF;

-- 7. LINK LEAVES
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (200, 101, 102);
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 200, 'Pending'); -- Dean
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (103, 200, 'Pending'); -- HR

INSERT INTO Unpaid_Leave (request_ID, Emp_ID) VALUES (201, 102); 
INSERT INTO Document (type, description, file_name, creation_date, status, emp_ID, unpaid_ID)
VALUES ('Memo', 'Need cash', 'doc.pdf', GETDATE(), 'valid', 102, 201);
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 201, 'Pending'); -- Dean
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (103, 201, 'Pending'); -- HR

-- 8. ATTENDANCE (For Compensation Test)
INSERT INTO Attendance (date, check_in_time, check_out_time, status, emp_ID)
VALUES ('2025-11-28', '09:00:00', '18:00:00', 'Attended', 102);

-- Deletes the conflicting record for Hadeel (Employee ID 101) for the semester W25
DELETE FROM Performance 
WHERE emp_ID = 101 AND semester = 'W25';


SELECT * FROM Performance WHERE emp_ID = 101;
...
-- 1. CLEANUP (Deletes ONLY the specific test IDs to ensure a fresh environment)
DELETE FROM Employee_Approve_Leave WHERE Emp1_ID IN (100, 103);
DELETE FROM Employee_Replace_Employee WHERE Emp1_ID IN (100, 101, 102);
DELETE FROM Annual_Leave WHERE emp_ID IN (100, 101, 102);
DELETE FROM Unpaid_Leave WHERE Emp_ID IN (100, 101, 102);
...
-- 2. FORCE BIG IDs (Ensures clean test environment)
-- Employees will start at ID 100, Leaves at ID 200
DBCC CHECKIDENT ('Employee', RESEED, 99);
DBCC CHECKIDENT ('Leave', RESEED, 199);
DBCC CHECKIDENT ('Attendance', RESEED, 0);
DBCC CHECKIDENT ('Document', RESEED, 0);

-- 3. SETUP DEPARTMENTS & ROLES (Includes all required roles, including the fixed HR Rep)
IF NOT EXISTS (SELECT * FROM Department WHERE name='MET') INSERT INTO Department VALUES ('MET','C');
IF NOT EXISTS (SELECT * FROM Department WHERE name='HR') INSERT INTO Department VALUES ('HR','B');
...
IF NOT EXISTS (SELECT * FROM Role WHERE role_name='HR Manager') 
   INSERT INTO Role VALUES ('HR Manager', 'Manager', 'Manage HR', 3, 60000, 18, 18, 40, 12);
IF NOT EXISTS (SELECT * FROM Role WHERE role_name='HR_Representative_MET') 
   INSERT INTO Role VALUES ('HR_Representative_MET', 'HR Rep', 'Assigns Approvals', 4, 50000, 15.00, 15.00, 35, 12);

IF NOT EXISTS (SELECT * FROM Role_existsIn_Department WHERE Role_name='Dean' AND department_name='MET') INSERT INTO Role_existsIn_Department VALUES ('MET','Dean');
IF NOT EXISTS (SELECT * FROM Role_existsIn_Department WHERE Role_name='Lecturer' AND department_name='MET') INSERT INTO Role_existsIn_Department VALUES ('MET','Lecturer');
IF NOT EXISTS (SELECT * FROM Role_existsIn_Department WHERE Role_name='HR Manager' AND department_name='HR') INSERT INTO Role_existsIn_Department VALUES ('HR','HR Manager');
IF NOT EXISTS (SELECT * FROM Role_existsIn_Department WHERE Role_name='HR_Representative_MET' AND department_name='HR') INSERT INTO Role_existsIn_Department VALUES ('HR','HR_Representative_MET');


-- 4. INSERT EMPLOYEES (IDs will start at 100)
...
VALUES 
('Hazem', 'Ali', '123', 'hazem@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'M', 'Friday'),         -- ID 100: Dean
('Hadeel', 'Adel', '123', 'hadeel@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'F', 'Friday'),       -- ID 101: Annual Applicant
('Sarah', 'Sabry', '123', 'sarah@guc.edu.eg', 'MET', 'full_time', 0, 10, 'active', 'F', 'Friday'),          -- ID 102: Unpaid Applicant (0 Balance)
('Ahmed', 'Helmy', '123', 'ahmed@guc.edu.eg', 'HR', 'full_time', 30, 10, 'active', 'M', 'Saturday');      -- ID 103: HR Manager/HR Rep (Approver)
...
(102, 'Lecturer'), 
(103, 'HR Manager'), 
(103, 'HR_Representative_MET'); -- CRUCIAL: Links Ahmed to the MET Dept for approval

-- 6. INSERT LEAVES (IDs will start at 200)
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) 
VALUES (GETDATE(), '2025-12-20', '2025-12-25', 'Pending'); -- Req 200 (Annual)
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) 
VALUES (GETDATE(), '2025-12-10', '2025-12-12', 'Pending'); -- Req 201 (Unpaid)

-- 7. LINK LEAVES & ASSIGN APPROVERS
-- Annual Leave #200: Assigned to Dean (100) and HR (103)
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (200, 101, 102); 
...
-- Unpaid Leave #201: Assigned to Dean (100)
INSERT INTO Unpaid_Leave (request_ID, Emp_ID) VALUES (201, 102); 
INSERT INTO Document (type, description, file_name, creation_date, status, emp_ID, unpaid_ID)
VALUES ('Memo', 'Need cash', 'doc.pdf', GETDATE(), 'valid', 102, 201);
...
-- 1. CLEANUP AND RESET IDENTITY COUNTERS
TRUNCATE TABLE Employee_Phone;
TRUNCATE TABLE Employee_Role;
TRUNCATE TABLE Annual_Leave;
TRUNCATE TABLE Accidental_Leave;
...
INSERT INTO Department VALUES ('MET_Giza','C'), ('HR_Central','B');
INSERT INTO Role (role_name, title, description, rank, base_salary, percentage_YOE, percentage_overtime, annual_balance, accidental_balance) VALUES 
('Dean_MET', 'Academic Dean', 'Manage Dept', 3, 60000, 18, 18, 40, 12),
('Lecturer_A', 'Lecturer', 'Teach Courses', 5, 45000, 12, 12, 30, 12),
('HR_M_Head', 'Manager', 'Manage HR', 3, 60000, 18, 18, 40, 12),
('HR_Rep_MET', 'HR Rep', 'Assigns Approvals for MET', 4, 50000, 15.00, 15.00, 35, 12);
INSERT INTO Role_existsIn_Department VALUES ('MET_Giza','Dean_MET'), ('MET_Giza','Lecturer_A'), ('HR_Central','HR_M_Head'), ('HR_Central','HR_Rep_MET');

-- 3. INSERT EMPLOYEES (IDs 100-103)
INSERT INTO Employee (first_name, last_name, password, email, dept_name, type_of_contract, annual_balance, accidental_balance, employment_status, gender, official_day_off)
VALUES 
('ZORP', 'Quasar', '123', 'zorp@guc.edu.eg', 'MET_Giza', 'full_time', 30, 10, 'active', 'M', 'Friday'),  -- ID 100: Dean
('ZARAK', 'Pluto', '123', 'zarak@guc.edu.eg', 'MET_Giza', 'full_time', 30, 10, 'active', 'F', 'Friday'),  -- ID 101: Annual Applicant
('XENA', 'Brave', '123', 'xena@guc.edu.eg', 'MET_Giza', 'full_time', 0, 10, 'active', 'F', 'Friday'),     -- ID 102: Unpaid Applicant (THE CONFLICT)
('AHM_HR', 'Beta', '123', 'ahm@guc.edu.eg', 'HR_Central', 'full_time', 30, 10, 'active', 'M', 'Saturday'); -- ID 103: HR Rep

INSERT INTO Employee_Role VALUES (100, 'Dean_MET'), (101, 'Lecturer_A'), (102, 'Lecturer_A'), (103, 'HR_M_Head'), (103, 'HR_Rep_MET');

-- 4. DELIBERATE FAILURE CASE (Request #202: Sarah's vacation)
INSERT INTO Leave (request_ID, date_of_request, start_date, end_date, final_approval_status) 
VALUES (202, GETDATE(), '2025-12-15', '2025-12-22', 'Approved'); -- Sarah is busy Dec 15-22
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (202, 102, 101); -- Sarah's approved leave

-- 5. PENDING REQUESTS (IDs 200, 201)
INSERT INTO Leave (request_ID, date_of_request, start_date, end_date, final_approval_status) 
VALUES (200, GETDATE(), '2025-12-20', '2025-12-25', 'Pending'); -- Req 200 (Annual)
INSERT INTO Leave (request_ID, date_of_request, start_date, end_date, final_approval_status) 
VALUES (201, GETDATE(), '2025-12-10', '2025-12-12', 'Pending'); -- Req 201 (Unpaid)

-- 6. LINK REQUEST #200 (THE FAILURE TARGET)
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (200, 101, 102); -- Hadeel needs Sarah
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 200, 'Pending'); -- Dean
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (103, 200, 'Pending'); -- HR

-- 7. LINK REQUEST #201 (THE SUCCESS TARGET)
INSERT INTO Unpaid_Leave (request_ID, Emp_ID) VALUES (201, 102); 
INSERT INTO Document (type, description, file_name, creation_date, status, emp_ID, unpaid_ID) VALUES ('Memo', 'Need cash', 'doc.pdf', GETDATE(), 'valid', 102, 201);
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 201, 'Pending');

-- 8. ATTENDANCE (For Compensation Test)
INSERT INTO Attendance (date, check_in_time, check_out_time, status, emp_ID) VALUES ('2025-11-28', '09:00:00', '18:00:00', 'Attended', 102);
...
---------------------------------------------------
-- 1. WIPE AND RESEED (Using DELETE and DBCC CHECKIDENT)
---------------------------------------------------

-- Delete children tables first (required for FK constraints)
...
-- Resetting IDENTITY for all tables (Ensures clean start at 100/200)
DBCC CHECKIDENT ('Employee', RESEED, 99);
DBCC CHECKIDENT ('Leave', RESEED, 199);
DBCC CHECKIDENT ('Document', RESEED, 999);
DBCC CHECKIDENT ('Attendance', RESEED, 0);
...
DBCC CHECKIDENT ('Employee_Replace_Employee', RESEED, 0);


---------------------------------------------------
-- 2. SETUP DATA (The Final, Correct Inserts)
---------------------------------------------------
...
INSERT INTO Role (role_name, title, description, rank, base_salary, percentage_YOE, percentage_overtime, annual_balance, accidental_balance) VALUES 
('Dean_MET', 'Academic Dean', 'Manage Dept', 3, 60000, 18, 18, 40, 12),
('Lecturer_A', 'Academic Lecturer', 'Teach Courses', 5, 45000, 12, 12, 30, 12),
('HR_M_Head', 'Manager', 'Manage HR', 3, 60000, 18, 18, 40, 12),
('HR_Rep_MET', 'HR Rep', 'Assigns Approvals for MET', 4, 50000, 15.00, 15.00, 35, 12); 
...
('MET_Giza','Dean_MET'), 
('MET_Giza','Lecturer_A'), 
('HR_Central','HR_M_Head'), 
('HR_Central','HR_Rep_MET');

-- INSERT EMPLOYEES (IDs will start at 100)
INSERT INTO Employee (first_name, last_name, password, email, dept_name, type_of_contract, annual_balance, accidental_balance, employment_status, gender, official_day_off)
VALUES 
('ZORP', 'Quasar', '123', 'zorp@guc.edu.eg', 'MET_Giza', 'full_time', 30, 10, 'active', 'M', 'Friday'),         
('ZARAK', 'Pluto', '123', 'zarak@guc.edu.eg', 'MET_Giza', 'full_time', 30, 10, 'active', 'F', 'Friday'),       
('XENA', 'Brave', '123', 'xena@guc.edu.eg', 'MET_Giza', 'full_time', 0, 10, 'active', 'F', 'Friday'),          
('AHM_HR', 'Beta', '123', 'ahm@guc.edu.eg', 'HR_Central', 'full_time', 30, 10, 'active', 'M', 'Saturday');

-- ASSIGN ROLES
INSERT INTO Employee_Role VALUES 
(100, 'Dean_MET'), (101, 'Lecturer_A'), (102, 'Lecturer_A'), (103, 'HR_M_Head'), (103, 'HR_Rep_MET'); 

-- INSERT LEAVES (IDs will start at 200)
-- Req 200 (Annual)
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-20', '2025-12-25', 'Pending'); 
-- Req 201 (Unpaid)
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-10', '2025-12-12', 'Pending'); 

-- LINK LEAVES & ASSIGN APPROVERS
-- Annual Leave #200 (Dean and HR approve)
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (200, 101, 102); 
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 200, 'Pending'); 
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (103, 200, 'Pending'); 
...
-- ATTENDANCE (For Compensation Test)
INSERT INTO Attendance (date, check_in_time, check_out_time, status, emp_ID) VALUES ('2025-11-28', '09:00:00', '18:00:00', 'Attended', 102);
...
-- 1. WIPE DATA (Using DELETE for safety and compliance)
...
-- 2. RESET IDENTITY COUNTERS (Ensures clean start at 100/200/1000)
-- This fixes the error where IDs would continue counting from old values.
DBCC CHECKIDENT ('Employee', RESEED, 99);
DBCC CHECKIDENT ('Leave', RESEED, 199);
DBCC CHECKIDENT ('Document', RESEED, 999);
DBCC CHECKIDENT ('Attendance', RESEED, 0);
...
('ZORP', 'Quasar', '123', 'zorp@guc.edu.eg', 'MET_Giza', 'full_time', 30, 10, 'active', 'M', 'Friday'),         -- ID 100: Dean
('ZARAK', 'Pluto', '123', 'zarak@guc.edu.eg', 'MET_Giza', 'full_time', 30, 10, 'active', 'F', 'Friday'),       -- ID 101: Annual Applicant
('XENA', 'Brave', '123', 'xena@guc.edu.eg', 'MET_Giza', 'full_time', 0, 10, 'active', 'F', 'Friday'),          -- ID 102: Unpaid Applicant (0 Balance)
('AHM_HR', 'Beta', '123', 'ahm@guc.edu.eg', 'HR_Central', 'full_time', 30, 10, 'active', 'M', 'Saturday');      -- ID 103: HR Rep
...
-- 3. SETUP DEPARTMENTS & ROLES (Simplified Names)
INSERT INTO Department VALUES ('MET','C'), ('HR','B');

INSERT INTO Role (role_name, title, description, rank, base_salary, percentage_YOE, percentage_overtime, annual_balance, accidental_balance) VALUES 
('Dean', 'Academic Dean', 'Manage Dept', 3, 60000, 18, 18, 40, 12), -- FIXED: Simple name 'Dean'
('Lecturer', 'Academic Lecturer', 'Teach Courses', 5, 45000, 12, 12, 30, 12),
('HR Manager', 'Manager', 'Manage HR', 3, 60000, 18, 18, 40, 12),
...
INSERT INTO Employee (first_name, last_name, password, email, dept_name, type_of_contract, annual_balance, accidental_balance, employment_status, gender, official_day_off)
VALUES 
('ZORP', 'Quasar', '123', 'zorp@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'M', 'Friday'),         -- ID 100: Dean
('ZARAK', 'Pluto', '123', 'zarak@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'F', 'Friday'),       -- ID 101: Annual Applicant
('XENA', 'Brave', '123', 'xena@guc.edu.eg', 'MET', 'full_time', 0, 10, 'active', 'F', 'Friday'),          -- ID 102: Unpaid Applicant
('AHM_HR', 'Beta', '123', 'ahm@guc.edu.eg', 'HR', 'full_time', 30, 10, 'active', 'M', 'Saturday');

-- 5. ASSIGN ROLES
INSERT INTO Employee_Role VALUES 
(100, 'Dean'), -- Linked to simple name 'Dean'
(101, 'Lecturer'), 
(102, 'Lecturer'), 
(103, 'HR Manager'), 
...
-- 1. INSERT MISSING SYSTEM ROLES into Role table
IF NOT EXISTS (SELECT 1 FROM Role WHERE role_name='President') 
   INSERT INTO Role VALUES ('President', 'Upper Board', 'Manage University', 1, 100000, 25.00, 25.00, NULL, NULL);

IF NOT EXISTS (SELECT 1 FROM Role WHERE role_name='Medical Doctor') 
   INSERT INTO Role VALUES ('Medical Doctor', 'Dr', 'Diagnosing patients', 5, 35000, 10.00, 10.00, 30, 6);

-- 2. ASSIGN ROLES to existing test users (IDs 100 and 101)

-- Assign President role to Dean Hazem (ID 100)
IF NOT EXISTS (SELECT 1 FROM Employee_Role WHERE emp_ID = 100 AND role_name = 'President')
   INSERT INTO Employee_Role VALUES (100, 'President');

-- Assign Medical Doctor role to Hadeel (ID 101)
IF NOT EXISTS (SELECT 1 FROM Employee_Role WHERE emp_ID = 101 AND role_name = 'Medical Doctor')
   INSERT INTO Employee_Role VALUES (101, 'Medical Doctor');
...
---------------------------------------------------
-- 1. WIPE DATA (Using DELETE and DBCC CHECKIDENT)
---------------------------------------------------
...
---------------------------------------------------
-- 2. SETUP DATA (The Complete Set of Roles/Users)
---------------------------------------------------
...
INSERT INTO Role (role_name, title, description, rank, base_salary, percentage_YOE, percentage_overtime, annual_balance, accidental_balance) VALUES 
('President', 'Upper Board', 'Manage University', 1, 100000, 25.00, 25.00, NULL, NULL), -- Added President
('Dean', 'Academic Dean', 'Manage Dept', 3, 60000, 18, 18, 40, 12),
('Lecturer', 'Academic Lecturer', 'Teach Courses', 5, 45000, 12, 12, 30, 12),
('HR Manager', 'Manager', 'Manage HR', 3, 60000, 18, 18, 40, 12),
('HR_Representative_MET', 'HR Rep', 'Assigns Approvals for MET', 4, 50000, 15.00, 15.00, 35, 12),
('Medical Doctor', 'Dr', 'Diagnosing patients', 5, 35000, 10.00, 10.00, 30, 6); -- Added Medical Doctor
...
INSERT INTO Employee (first_name, last_name, password, email, dept_name, type_of_contract, annual_balance, accidental_balance, employment_status, gender, official_day_off)
VALUES 
('ZORP', 'Quasar', '123', 'zorp@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'M', 'Friday'),         -- ID 100: Dean + President (Approver 1)
('ZARAK', 'Pluto', '123', 'zarak@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'F', 'Friday'),       -- ID 101: Employee + Doctor (Approver 2)
...
-- ASSIGN ROLES
INSERT INTO Employee_Role VALUES 
(100, 'Dean'), (100, 'President'), -- Hazem is Dean & President (Handles all Upper Board approvals)
(101, 'Lecturer'), (101, 'Medical Doctor'), -- Hadeel is Lecturer & Doctor (Handles Medical approval)
(102, 'Lecturer'), 
(103, 'HR Manager'), (103, 'HR_Representative_MET'); -- Ahmed is HR Rep (Handles generic HR approvals)

-- INSERT PRE-MADE LEAVES (For Approval Tests)
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-20', '2025-12-25', 'Pending'); -- Req 200 (Annual)
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-10', '2025-12-12', 'Pending'); -- Req 201 (Unpaid)
...
-- Annual Leave #200 (Dean and HR Rep approve)
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (200, 101, 102); 
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 200, 'Pending'); -- Dean/President
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (103, 200, 'Pending'); -- HR Rep

-- Unpaid Leave #201 (Dean and President approve)
INSERT INTO Unpaid_Leave (request_ID, Emp_ID) VALUES (201, 102); 
INSERT INTO Document (type, description, file_name, creation_date, status, emp_ID, unpaid_ID)
VALUES ('Memo', 'Unpaid Request Memo', 'doc.pdf', GETDATE(), 'valid', 102, 201);
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 201, 'Pending'); -- Dean
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 201, 'Pending'); -- President (This duplication must be handled in SQL, but we rely on system logic to use the same ID)
...
---------------------------------------------------
-- 1. WIPE AND RESET (Using DELETE for safe cleanup)
---------------------------------------------------
DELETE FROM Employee_Phone; DELETE FROM Employee_Role; DELETE FROM Annual_Leave; DELETE FROM Accidental_Leave; DELETE FROM Compensation_Leave; 
DELETE FROM Role_existsIn_Department; DELETE FROM Employee_Replace_Employee; DELETE FROM Employee_Approve_Leave; 
DELETE FROM Deduction; DELETE FROM Performance; DELETE FROM Payroll; DELETE FROM Document; 
DELETE FROM Medical_Leave; DELETE FROM Unpaid_Leave; DELETE FROM Attendance; DELETE FROM Leave; 
DELETE FROM Employee; DELETE FROM Department; DELETE FROM Role;
...
('Lecturer', 'Academic Lecturer', 'Teach Courses', 5, 45000, 12, 12, 30, 12),
('HR_Representative_MET', 'HR Rep', 'Assigns Approvals for MET', 4, 50000, 15.00, 15.00, 35, 12),
('Medical Doctor', 'Dr', 'Diagnosing patients', 5, 35000, 10.00, 10.00, 30, 6);

-- 3. INSERT EMPLOYEES (IDs 100-103)
INSERT INTO Employee (first_name, last_name, password, email, dept_name, type_of_contract, annual_balance, accidental_balance, employment_status, gender, official_day_off)
VALUES 
('ZORP', 'Quasar', '123', 'zorp@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'M', 'Friday'),         -- ID 100: Dean
('ZARAK', 'Pluto', '123', 'zarak@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'F', 'Friday'),       -- ID 101: President/Doctor (Annual Applicant)
('XENA', 'Brave', '123', 'xena@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'F', 'Friday'),          -- ID 102: Employee (Compensation Applicant)
('AHM_HR', 'Beta', '123', 'ahm@guc.edu.eg', 'HR', 'full_time', 30, 10, 'active', 'M', 'Saturday');      -- ID 103: HR Rep

INSERT INTO Employee_Role VALUES 
(100, 'Dean'), (101, 'President'), (101, 'Lecturer'), (101, 'Medical Doctor'), 
(102, 'Lecturer'), (103, 'HR_Representative_MET');

-- 4. INSERT LEAVE REQUESTS (The Setup)

-- WORKING PATHS (For Success Demo):
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-20', '2025-12-25', 'Pending'); -- Req 200 (Annual)
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (200, 101, 102); 
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 200, 'Pending'); -- Dean

-- FAILURE PATH 1: REPLACEMENT CONFLICT (Req 202)
-- XENA (102) is made busy during the time ZORP (100) needs her as replacement for #200.
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-15', '2025-12-22', 'Approved'); 
INSERT INTO Annual_Leave (request_ID, emp_ID, replacement_emp) VALUES (202, 102, 101); -- XENA's approved leave overlaps #200

-- FAILURE PATH 2: UNPAID BALANCE VIOLATION (Req 203)
-- ZORP (100) requests unpaid leave, but has 30 days balance.
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2026-01-01', '2026-01-05', 'Pending');
INSERT INTO Unpaid_Leave (request_ID, Emp_ID) VALUES (203, 100);
INSERT INTO Document (type, description, file_name, creation_date, status, emp_ID, unpaid_ID) VALUES ('Memo', 'Unpaid balance test', 'memo_203.pdf', GETDATE(), 'valid', 100, 203);
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (103, 203, 'Pending'); -- HR Approves

-- FAILURE PATH 3: COMPENSATION DAY OFF VIOLATION (Req 204)
-- ZARAK (101) requests compensation for working on a Tuesday (should be Friday).
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2026-01-15', '2026-01-15', 'Pending');
INSERT INTO Compensation_Leave (request_ID, reason, date_of_original_workday, emp_ID, replacement_emp) 
VALUES (204, 'Holiday Work', '2025-11-26', 101, 102); -- Nov 26 is a Tuesday, ZARAK's day off is Friday.

-- 5. ATTENDANCE (Required for Compensation Failure Check)
INSERT INTO Attendance (date, check_in_time, check_out_time, status, emp_ID)
VALUES ('2025-11-26', '09:00:00', '17:00:00', 'Attended', 101); -- Attendance for Comp failure check
...
-- Delete all child table data first
DELETE FROM Employee_Phone;
DELETE FROM Employee_Role;
DELETE FROM Annual_Leave;
DELETE FROM Accidental_Leave;
...
-- Resetting IDENTITY for all tables (Crucial Fix for PK violations)
DBCC CHECKIDENT ('Employee', RESEED, 99);
DBCC CHECKIDENT ('Leave', RESEED, 199);
DBCC CHECKIDENT ('Document', RESEED, 999);
DBCC CHECKIDENT ('Attendance', RESEED, 0);
...
---------------------------------------------------
-- 2. SETUP CORE DATA (Final, Complete Role Definitions)
---------------------------------------------------

INSERT INTO Department VALUES ('MET','C'), ('HR','B'), ('MEDICAL','B');

INSERT INTO Role (role_name, title, description, rank, base_salary, percentage_YOE, percentage_overtime, annual_balance, accidental_balance) VALUES 
('President', 'Upper Board', 'Manage University', 1, 100000, 25.00, 25.00, 40, 12),
('Dean', 'Academic Dean', 'Manage Dept', 3, 60000, 18, 18, 40, 12),
('Lecturer', 'Academic Lecturer', 'Teach Courses', 5, 45000, 12, 12, 30, 12),
('HR Manager', 'Manager', 'Manage HR', 3, 60000, 18, 18, 40, 12),
('HR_Representative_MET', 'HR Rep', 'Assigns Approvals for MET', 4, 50000, 15.00, 15.00, 35, 12),
...
VALUES 
('ZORP', 'Quasar', '123', 'zorp@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'M', 'Friday'),         -- ID 100: Dean
('ZARAK', 'Pluto', '123', 'zarak@guc.edu.eg', 'MET', 'full_time', 30, 10, 'active', 'F', 'Friday'),       -- ID 101: President/Doctor
('XENA', 'Brave', '123', 'xena@guc.edu.eg', 'MET', 'full_time', 0, 10, 'active', 'F', 'Friday'),          -- ID 102: Employee (0 Balance)
('AHM_HR', 'Beta', '123', 'ahm@guc.edu.eg', 'HR', 'full_time', 30, 10, 'active', 'M', 'Saturday');      -- ID 103: HR Rep

-- 4. ASSIGN ROLES (Separating Dean/President and adding Doctor)
INSERT INTO Employee_Role VALUES 
(100, 'Dean'), 
(101, 'President'), -- CRUCIAL FIX: Separated President ID
(101, 'Lecturer'), 
(101, 'Medical Doctor'), -- CRUCIAL FIX: Assigned Medical Doctor role
(102, 'Lecturer'), 
(103, 'HR Manager'), 
(103, 'HR_Representative_MET');

-- 5. INSERT LEAVES (IDs will start at 200)
-- Req 200 (Annual) - Working Path
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-20', '2025-12-25', 'Pending'); 
-- Req 201 (Unpaid) - Working Path
INSERT INTO Leave (date_of_request, start_date, end_date, final_approval_status) VALUES (GETDATE(), '2025-12-10', '2025-12-12', 'Pending'); 
...
-- Unpaid Leave #201 
INSERT INTO Unpaid_Leave (request_ID, Emp_ID) VALUES (201, 102); 
INSERT INTO Document (type, description, file_name, creation_date, status, emp_ID, unpaid_ID) VALUES ('Memo', 'Unpaid Request Memo', 'doc.pdf', GETDATE(), 'valid', 102, 201);
INSERT INTO Employee_Approve_Leave (Emp1_ID, leave_ID, status) VALUES (100, 201, 'Pending'); -- Dean
